...
function Leaderboard() {
  ...
  useEffect(() => {
    axios.get('https://jigsawjunctionbackend.onrender.com/api/logical/sort').then((response) => {
  ...
  useEffect(() => {
    axios.get('https://jigsawjunctionbackend.onrender.com/api/wordhunt/sort').then((response) => {
